...
vim.keymap.set("n","<leader>z",require("nvim-tree.api").tree.focus)
...
-- Set Tab stop to 4 and Shiftwidth to 4
...
pcall(require('telescope').load_extension, 'folder_browser')
...
vim.keymap.set('', '<leader>r', "<Plug>RestNvim<cr>", { desc = "run the request" })
vim.keymap.set('', '<leader>rp', "<Plug>RestNvimPreview<cr>", { desc = "preview Curl command" })
vim.keymap.set('', '<leader>rl', "<Plug>RestNvimLast<cr>", { desc = "rerun last request" })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<Leader>1', '<Plug>RestNvim', 'Run HTTP request')
  nmap('<Leader>2', '<Plug>RestNvimPreview', 'Preview cURL Command')
  nmap('<Leader>3', '<Plug>RestNvimLast', 'Re-Run last Command')
